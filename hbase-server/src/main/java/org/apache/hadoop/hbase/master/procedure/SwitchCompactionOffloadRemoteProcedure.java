...
public class SwitchCompactionOffloadRemoteProcedure extends ServerRemoteProcedure
  ...
  private static final Logger LOG = LoggerFactory.getLogger(SwitchCompactionOffloadRemoteProcedure.class);
  private boolean rpcThrottleEnabled;

  public SwitchCompactionOffloadRemoteProcedure() {
  }

  public SwitchCompactionOffloadRemoteProcedure(ServerName serverName, boolean rpcThrottleEnabled) {
  ...
  protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
    SwitchCompactionOffloadRemoteStateData.newBuilder()
        ...
        .setCompactionOffloadEnabled(rpcThrottleEnabled).build();
  }
  ...
  protected void deserializeStateData(ProcedureStateSerializer serializer) throws IOException {
    ...
    rpcThrottleEnabled = data.getCompactionOffloadEnabled();
  }
  ...
  public Optional<RemoteProcedureDispatcher.RemoteOperation> remoteCallBuild(
    ...
    return Optional.of(new RSProcedureDispatcher.ServerOperation(this, getProcId(),
        SwitchCompactionOffloadRemoteCallable.class, SwitchCompactionOffloadRemoteStateData.newBuilder()
        .setTargetServer(ProtobufUtil.toServerName(remote))
        .setCompactionOffloadEnabled(rpcThrottleEnabled).build().toByteArray()));
  }
