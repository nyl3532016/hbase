...
public class CompactionOffloadSwitchStorage {
  public static final String COMPACTION_OFFLOAD_ZNODE = "zookeeper.znode.compaction.offload";
  public static final String COMPACTION_OFFLOAD_ZNODE_DEFAULT = "compaction-offload";
  ...
  public void switchCompactionOffload(boolean enable) throws IOException {
    try {
      ...
      throw new IOException("Failed to store compaction offload switch", e);
    }
  }
}
