...
public class SwitchCompactionOffloadProcedure
  ...
  public SwitchCompactionOffloadProcedure(CompactionOffloadSwitchStorage compactionOffloadSwitchStorage,
      boolean CompactionOffloadEnabled, ServerName serverName, final ProcedurePrepareLatch syncLatch) {
  ...
  @Override
  protected int getStateId(SwitchCompactionOffloadState throttleState) {
  ...
  protected void serializeStateData(ProcedureStateSerializer serializer) throws IOException {
    ...
    serializer.serialize(
      SwitchCompactionOffloadStateData.newBuilder().setCompactionOffloadEnabled(CompactionOffloadEnabled).build());
  }

  @Override
  protected void deserializeStateData(ProcedureStateSerializer serializer) throws IOException {
    super.deserializeStateData(serializer);
    SwitchCompactionOffloadStateData data = serializer.deserialize(SwitchCompactionOffloadStateData.class);
  ...
  public void switchThrottleState(MasterProcedureEnv env, boolean CompactionOffloadEnabled)
      throws IOException {
